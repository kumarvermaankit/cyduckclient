...
event.preventDefault()
  ...
  const result=await axios.post(`${url}/upload/question`,{question:question,info:info,keywords:{languages:selectedlang,frameworks:selectedfram,fields:selectedfield},links:availablelinks,imageinfo:questionimg})
  if(result){
    await setFile([])
...
<MultiSelect
 ...
 {/* <div className="headcard">
<a style={{marginLeft:"450px",cursor:"pointer",color:"#ece2e1",fontSize:"30px"}} onClick={(event)=>Paystate(event)}>Payment Options</a>
</div> */}
{/* <CSSTransition
  in={paymentstate}
  timeout={2000}
