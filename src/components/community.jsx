        ...
        return (
            ...
            <div style={{ display: "flex" }}>
                <div id={props.i} key={props.i} className="headercard" >
                    ...
                    <a href={`/ques/${props.i}/${props.doc_name}/${props.u}`}><b><p style={{ color: "black", width: "450px" }}>{props.t.substring(0, 100)}</p></b><p className="username1">Asked By {props.u}</p><p className="date">{props.create !== null ? format(props.create) : "July 2021"}</p>  </a>
