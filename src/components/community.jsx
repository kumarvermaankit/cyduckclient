...
const Items=()=>{
    ...
    {arr.map((each)=>{
     ...
     return <Quesdiv key={each.info.id} t={each.info.question_title}   i={each.info.id} u={each.info.username}    doc_name={each.info.documentname} index={each.index} time={each.info.time} create={each.info.createdAt}/>
